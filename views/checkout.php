...
$livraison1=new livraison($_POST['idclient'],$_POST['nom'],$_POST['adresse'],$_POST['numtel'] ,$row['num_com'],$liv,$somme+=$_POST['total']);
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light ftco-navbar-light-2" id="ftco-navbar">
	    <div class="container">
          ...
          <li class="nav-item"><a href="dashbord.php" class="nav-link">dashbord</a></li>
